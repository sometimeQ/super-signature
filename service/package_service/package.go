...
<plist version="1.0">
	...
	var servercatPath = fmt.Sprintf(conf.Config.ApplePath + ".server.crt")
	var keyPath = fmt.Sprintf(conf.Config.ApplePath + ".server.key")
	var cacatPath = fmt.Sprintf(conf.Config.ApplePath + ".ca.crt")
